...
/**
 * \file    calibracion/core/boxes/calibracionwidget1.php
 * \ingroup calibracion
 * \brief   Widget provided by Calibracion
 *
 ...
 */
class calibracionwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "calibracionbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "calibracion@calibracion";
	 ...
	 */
	public $depends = array('calibracion');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "calibracion@calibracion"));
		...
		// $this->hidden = !$user->hasRight('calibracion', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("CalibracionBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_calibracion@calibracion',
