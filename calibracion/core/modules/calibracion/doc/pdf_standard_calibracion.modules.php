...
/**
 *  \file       core/modules/calibracion/doc/pdf_standard.modules.php
 *  \ingroup    calibracion
...
/**
 *	Class to manage PDF template standard_calibracion
 */
class pdf_standard_calibracion extends ModelePDFCalibracion
{
	/**
	 ...
	 *
	 *  @param		Calibracion	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Calibracion	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('CALIBRACION_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('CALIBRACION_DRAFT_WATERMARK')));
		}
