...
/**
 * \file    core/triggers/interface_99_modCalibracion_CalibracionTriggers.class.php
 * \ingroup calibracion
 ...
 *      - interface_99_modCalibracion_MyTrigger.class.php
...
/**
 *  Class of triggers for Calibracion module
 */
class InterfaceCalibracionTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Calibracion triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'calibracion@calibracion';
	}
